...
const eventTitleKeys: Record<string, MessageKey> = {
  ...
  "server.game-update.auto-check": "eventTitleServerGameUpdateAutoCheckUpdated",
  "server.game-update.auto-check.queued": "eventTitleServerGameUpdateAutoCheckQueued",
