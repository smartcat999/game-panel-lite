...
const labels: Record<string, Record<Locale, string>> = {
  ...
  "server.game-update.auto-check": { zh: "自动检查设置", en: "Auto-check Settings" },
  "server.game-update.auto-check.queued": { zh: "自动检查排队", en: "Auto-check Queued" },
  ...
  "mod_config.saved": { zh: "模组配置保存", en: "Mod Config Saved" },
  "mod_config.uploaded": { zh: "模组配置上传", en: "Mod Config Uploaded" },
  "mod_config.deleted": { zh: "模组配置删除", en: "Mod Config Deleted" },
...
const zhTemplates: Record<string, (message: string) => string | undefined> = {
  ...
  "server.game-update.auto-check": (message) => withMatch(message, /^Updated automatic game update checks for (.+)$/, ([name]) => `已更新 ${name} 的自动更新检查设置`),
  ...
  "mod_config.saved": (message) => withMatch(message, /^Saved mod config (.+)$/, ([name]) => `已保存模组配置 ${name}`),
  "mod_config.uploaded": (message) => withMatch(message, /^Uploaded mod config (.+)$/, ([name]) => `已上传模组配置 ${name}`),
  "mod_config.deleted": (message) => withMatch(message, /^Deleted mod config (.+)$/, ([name]) => `已删除模组配置 ${name}`),
