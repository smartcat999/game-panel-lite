...
const labels: Record<string, Record<Locale, string>> = {
  ...
  "world.duplicated": { zh: "世界复制", en: "World Duplicated" },
  "world.migrated": { zh: "世界迁移", en: "World Migrated" },
  "world.deleted": { zh: "世界删除", en: "World Deleted" },
  "backup.created": { zh: "备份创建", en: "Backup Created" },
  "backup.restored": { zh: "备份恢复", en: "Backup Restored" },
  "backup.migrated": { zh: "备份迁移", en: "Backup Migrated" },
...
const zhTemplates: Record<string, (message: string) => string | undefined> = {
  ...
  "world.duplicated": (message) => withMatch(message, /^Duplicated world (.+)$/, ([name]) => `已复制世界 ${name}`),
  "world.migrated": (message) => withMatch(message, /^Migrated world (.+)$/, ([name]) => `已迁移世界 ${name}`),
  ...
  "backup.migrated": (message) => withMatch(message, /^Migrated backup (.+)$/, ([name]) => `已迁移备份 ${name}`),
